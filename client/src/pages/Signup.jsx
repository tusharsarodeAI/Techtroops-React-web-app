...
const Signup = () => {
  return (
    <div>
     <section className="bg-gray-1 dark:bg-dark lg:pt-10">
    <div className="container w-[300px] mx-auto lg:w-[450px]">
      <div className="-mx-4 flex flex-wrap">
        <div className="w-full px-4">
          <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
            <div className="mb-4 text-center md:mb-4">
            <div className=' md:px-8 py-7 px-8 text-2xl flex items-center justify-center '>
            ...
            <form>
              ...
              <div className="mb-10">
                <input
                  type="submit"
                  value="Sign up"
                  className="w-full cursor-pointer rounded-md border border-primary bg-blue-800 px-5 py-3 text-base font-medium text-white transition hover:bg-opacity-90"
                />
              </div>
            </form>
